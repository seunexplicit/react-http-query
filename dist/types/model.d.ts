...
export type MakeRequest<T, E> = (url: string, config?: GetRequestPayload | BodyRequestPayload | FormDataRequestPayload) => Promise<IResponse<T, E>['data']>;
...
export type HandlerDependency<T, E> = Omit<Partial<Omit<GetRequestPayload & BodyRequestPayload & FormDataRequestPayload & PrivateContextProps & UseRequestProps<T, E>, 'method'>> & {
