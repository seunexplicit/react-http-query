...
| -------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ---------------------------------------------------------------------- |
| method         | This could be one of `GET`, `POST`, `PUT`, `PATCH`, `DELETE`, `HEAD`, `OPTIONS`. it determines the type of request that is to be made                                                                                                                                                                                                                                                                            | `GET` if there is no request _body_. `POST` if there is a request body |
...
> **Note:** > `makeRequest` function also returns the request's response if it is await in an async
